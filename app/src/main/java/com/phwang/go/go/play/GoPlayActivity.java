...
public class GoPlayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private GoPlayReceiver goPlayReceiver_;
    ...
    private void registerBroadcastReceiver() {
        if (this.goPlayReceiver_ == null) {
            this.goPlayReceiver_ = new GoPlayReceiver(this);
            IntentFilter filter = new IntentFilter();
            filter.addAction(IntentDefine.GO_HEAD_ACTIVITY);
            this.registerReceiver(this.goPlayReceiver_, filter);
        }
    }

    private void unregisterBroadcastReceiver() {
        if (this.goPlayReceiver_ != null) {
            this.unregisterReceiver(this.goPlayReceiver_);
            this.goPlayReceiver_ = null;
        }
    }
}
